...
由于笔者平时有用LaTex书写数学笔记及编写论文的需求，希望能够编写一个简单的模板，供笔者和感兴趣的读者使用。模板内容主要参考https://zhuanlan.zhihu.com/p/604236564 ，笔者在此基础上进行微调，使模板结构更加清晰易用。

2024.1.4补充：增加了试卷解答模板和知乎书写模板。
